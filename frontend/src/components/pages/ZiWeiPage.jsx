      ...
      <nav style={topNavBar}>
        ...
        <div style={navTabsContainer}>
          {['origins', 'codex', 'drawing'].map((tab) => (
            ...
            >
              {tab === 'origins' ? <div><div>ASTRAL ROOT</div><div style={subLabel}>紫微源流</div></div>
                : tab === 'codex' ? <div><div>CONSTELLIA</div><div style={subLabel}>星曜秘典</div></div>
                : <div><div>ALIGNED</div><div style={subLabel}>命盤紀錄</div></div>}
